...
export function PhoneCallIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M14 4a4 4 0 0 1 4 4" />
      <path d="M14 1a7 7 0 0 1 7 7" />
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.362 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.338 1.85.573 2.81.7A2 2 0 0 1 22 16.92Z" />
    </svg>
  );
}
...
export function FacebookIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M14.5 21v-7.6h2.55l.38-2.96h-2.93V8.55c0-.86.24-1.44 1.47-1.44h1.57V4.46C17.2 4.41 16.25 4.33 15.15 4.33c-2.3 0-3.88 1.4-3.88 3.98v2.22H8.7v2.96h2.57V21h3.23Z" />
    </svg>
  );
}
...
export function EarIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M6 18.5A2.5 2.5 0 0 0 8.5 21c1.5 0 3-1.06 3-3v-1.5" />
      <path d="M17 20c-4.5 0-8-3.5-8-8V7a5 5 0 0 1 10 0" />
      <path d="M13.5 9a1.5 1.5 0 1 1 -3 0" />
    </svg>
  );
}
